package pe.edu.galaxy.training.java.ms.sc.ventas.mscoregestionproductos.utils;

public class Constantes {
	public final static String API_PRODUCTO = "/v1/productos";
	...
	public final static String DOCUMENTACION_TITULO = "Productos API";
	public final static String DOCUMENTACION_DESCRIPCION = "Documentacion de Productos";
