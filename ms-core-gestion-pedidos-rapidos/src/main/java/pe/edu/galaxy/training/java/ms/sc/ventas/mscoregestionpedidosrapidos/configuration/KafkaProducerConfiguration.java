...
public class KafkaProducerConfiguration {
	...
	@Bean
	public ProducerFactory<String, Orden> pedidoProducerFactory() {
	...
	@Bean
	public KafkaTemplate<String, Orden> pedidoKafkaTemplate() {
	
		KafkaTemplate<String, Orden> kafkaTemplate = new KafkaTemplate<>(pedidoProducerFactory());
		...
		kafkaTemplate.setProducerListener(new ProducerListener<String, Orden>() {
			...
			@Override
			public void onError(ProducerRecord<String, Orden> producerRecord, RecordMetadata recordMetadata, Exception exception) {
