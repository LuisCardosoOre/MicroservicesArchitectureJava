package pe.edu.galaxy.training.java.ms.sc.ventas.mscoregestionguiasredis.utils;

public class Constantes {
	
	public final static String API_GUIA = "/v1/guias-redis";
	...
	public final static String DOCUMENTACION_TITULO = "Guias Redis API";
	public final static String DOCUMENTACION_DESCRIPCION = "Documentacion de Guias en Redis";
